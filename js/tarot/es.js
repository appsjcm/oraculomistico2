/* ============================================================
   ORÁCULO MÍSTICO · CONTENIDO DE LOS ARCANOS · ESPAÑOL
   Fase 13A. El texto de cada carta vive aquí, separado de la
   estructura del mazo y de las imágenes. Las claves son las
   mismas en los seis idiomas: M00-M21 y B/C/E/O 01-14.

   yesNo guarda un código, no una etiqueta: yes, likely_yes,
   neutral, depends, likely_no, no. Traducirlo es cosa de la
